...
section = ""
subsection = ""
odmap_dict_rmd = filter(odmap_dict,! paragraph_id %in% c("o_title_1", "o_authorship_1", "o_authorship_2"))
for(i in 1:nrow(odmap_dict_rmd)){
  ...
  # Render paragraphs
  switch(odmap_dict_rmd$paragraph_type[i],
         text = knit_text(odmap_dict_rmd$paragraph_id[i]),
         suggestion = knit_suggestion(odmap_dict_rmd$paragraph_id[i]),
         extent = knit_extent(odmap_dict_rmd$paragraph_id[i]),
         model_algorithm = knit_suggestion(odmap_dict_rmd$paragraph_id[i]),
         model_setting = knit_model_settings(odmap_dict_rmd$paragraph_id[i]))
}
